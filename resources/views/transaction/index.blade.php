                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap p-4">
                                    <a href="{{ route('transaction.pdf', $transaction) }}" class="inline-block rounded bg-green-600 px-4 py-2 text-xs font-medium text-white hover:bg-green-700">Cetak PDF</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
